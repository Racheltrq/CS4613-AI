	...
	def forwardChecking(self):
		...
		for row in range(9):
			...
			for col in range(9):
				...
				#print(self.lst[row][col], self.lst[row][col] == "0")
...
def main():
	...
	print(state_new.search());
	#print(state_new.domain);
	#setForm(state_new.lst);
